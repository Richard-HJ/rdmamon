...
my @pkt_size     = (700000, 500000, 400000, 300000, 200000, 100000, 50000, 8900,  4000 );
my @file_postfix = ("10a",  "10",   "11",   "12",   "13",   "14",   "15",  "16",  "17");
# my $cmd_rdmamon =" -w0 -i0.1 -e20 ";
...
my $rdmamon_prog = "rdmamon_uc_mon -x";
my $rdmamon_path;
