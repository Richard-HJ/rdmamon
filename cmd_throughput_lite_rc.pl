#!/usr/bin/perl
# cmd_throughput_lite_rc.pl open date-time file, 
#                     use rdmamon_rc_mon to measure Achievable UDP Throughput as function of packet spacing & size
#input 
#   -a= CPU affinity
#   -d= remote host 
#   -l= no packets
...
my @pkt_size     = (80000, 50000, 20000, 8972,  4000 );
my @file_postfix = ("10a", "11",  "12",  "14",  "16");
my $cmd_rdmamon =" -w0 -i0.1 -e40 ";
# 
#  ....................................................................
# 
...
my $rdmamon_prog = "rdmamon_rc_mon -x";
my $rdmamon_path;
...
for($pkt_index=0; $pkt_index<=$pkt_index_max; $pkt_index++){
    ...
    $cmd = $rdmamon_path.$cmd_rdmamon." -d ".$opt_d." -p ".$size." -l ".$opt_l;   
    $out =`$cmd 2>&1`;
